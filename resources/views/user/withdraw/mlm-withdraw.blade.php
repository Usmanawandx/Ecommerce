                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            @endif
                            <form id="geniusform" action="{{ route('mlm-withdraw_store') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="bank_name" placeholder="Bank" value="" required >
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="account_title"
                                               placeholder="Account Title" required="" value="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="iban" placeholder="IBAN Number" required="" value="">
                                    </div>
                                </div>
{{--                                <div class="row">--}}
{{--                                    <div class="col-lg-4">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">Wthdraw Date *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="date" class="input-field" name="deposit_date" placeholder="Deposit Date" value="{{ date("Y-m-d") }}" required >
                                    </div>
                                </div>
{{--                                <div class="row">--}}
{{--                                    <div class="col-lg-4">--}}
