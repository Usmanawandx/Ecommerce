            ...
            <div class="col-lg-12">
                <div class="product-description">
                    <div class="body-area">
                        ...
                        @endif
                        <form id="geniusform" action="{{ route('set_profit_distribute') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
...
{{--                            </div>--}}
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="left-area">
                                        <h4 class="heading">Percentage *</h4>
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <input type="text" class="input-field" name="percentage"
                                           placeholder="e.g. 0.1, 0.5" required="" value="">
                                </div>
                            </div>
{{--                            <div class="row">--}}
{{--                                <div class="col-lg-4">--}}
