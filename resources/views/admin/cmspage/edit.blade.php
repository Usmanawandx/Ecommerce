...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit CMS Page') }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-cmspage-edit',$data->id) }}">{{ __('Edit') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-cmspage-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="title" placeholder="{{ __('Title') }}" required="" value="{{$data->page_title}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="slug" placeholder="{{ __('Slug') }}" required="" value="{{$data->page_slug}}">
                            </div>
                          </div>
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-7">
                              <input type="file" class="form-control-file" name="sliders[]" placeholder="{{ __('Top Sliders') }}" required="" multiple value="{{$data->page_slug}}">
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="slider_status" id="slider_status" value="1" {{$data->slider_status = 1 ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="block1_status" id="block1_status" value="1" {{$data->block1_status = 1 ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="block2_status" id="block2_status" value="1" {{$data->block2_status = 1 ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="block3_status" id="block3_status" value="1" {{$data->block3_status = 1 ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="block4_status" id="block4_status" value="1" {{$data->block4_status = 1 ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="block5_status" id="block5_status" value="1" {{$data->block5_status = 1 ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="block6_status" id="block6_status" value="1" {{$data->block6_status = 1 ? 'checked' : ''}}>
