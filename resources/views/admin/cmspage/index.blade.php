...
@section('content')
					<input type="hidden" id="headerdata" value="{{ __('CMS PAGE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('CMS Pages') }}</h4>
										<ul class="links">
											<li>
...
@section('scripts')
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-cmspage-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" href="{{route('admin-cmspage-create')}}">'+
