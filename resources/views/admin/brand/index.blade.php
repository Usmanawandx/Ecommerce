						...
						<div class="product-area">
							<div class="row">
								<div class="col-lg-12">
                                    ...
                                    <span style="margin-top:10px;"><a class="btn btn-primary" href="{{ route("export-brand") }}">Export Brands</a></span>
                                    <br>
                                    <br>
...
<script>
    $(document).on("change",".isfeauture",function(){
		// alert($(this).is(':checked'));
			id = $(this).attr('data-brand');
			check = $(this).is(':checked');
				$.ajax({
				type: "GET",
				url :"{{route('admin-brand-isfeauture')}}",
				data: {
					'id':id,
					'check':check
				},
