...
<input type="hidden" id="headerdata" value="{{ __('ORDER') }}">
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __('All Vendor PO') }}</h4>
                                        <ul class="links">
                                            <li>
                                                <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                                            </li>
                                            <li>
                                                <a href="javascript:;">{{ __('Vendor Purchase Order') }}</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('vendor_po.all','All') }}">{{ __('All PO') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        url="{{ route('admin-vpo-datatables','All') }}";
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-po-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
