                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="tawk-area">
                                      <input type="text" required class="input-field" value="{{$data->title}}" name="title" placeholder="Enter Title">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
...
<div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Current Slider') }} *</h4>
                            </div>
                          </div>
                          <div class="col-lg-8">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->slider ? asset('assets/images/categories/'.$data->slider):asset('assets/images/noimage.png') }});">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link" placeholder="{{ __('Enter Slider Link') }}" value="{{$data->link}}">
                          </div>
                        </div>
                        <div class="row">
						<div class="col-lg-4">
						...
						<div class="col-lg-7">
                            <div class="checkbox-wrapper">
                              <input type="checkbox" name="slider_status" id="slider_status" value="1" {{ $data->slider_status != 0 ? "checked":"" }}>
