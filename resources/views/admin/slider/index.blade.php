                        ...
                        @include('includes.admin.form-success')  
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        <th>{{ __('Featured Image Desktop') }}</th>
									                        <th>{{ __('Featured Image IPad') }}</th>
									                        <th>{{ __('Featured Image Mobile') }}</th>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               columns: [
                        ...
                        { data: 'photo_ipad', name: 'photo_ipad' , searchable: false, orderable: false},
                        { data: 'photo_mobile', name: 'photo_mobile' , searchable: false, orderable: false},
