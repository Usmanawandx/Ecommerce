                    ...
                    <div class="product-description">
                      ...
                      @include('includes.admin.form-both') 
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link_ipad" placeholder="{{ __('Link IPad') }}" required="" value="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link_mobile" placeholder="{{ __('Link Mobile') }}" required="" value="">
                          </div>
                        </div>
