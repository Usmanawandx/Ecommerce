                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-role-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-2"></div>
                            <div class="col-lg-4 d-flex justify-content-between">
                              <label class="control-label">{{ __('Bulk Image Upload') }} *</label>
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="bulk_image_upload" {{ $data->sectionCheck('bulk_image_upload') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              <label class="control-label">{{ __('Shipping Details') }} *</label>
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="shipping_details" {{ $data->sectionCheck('shipping_details') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
