...
<div class="modal fade" id="change-password" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin-vendor-changepass')}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                            <label for="vendor-pass">New Password</label>
                        </div>
                        <div class="col-md-6">
                            <input type="hidden" name="id" id="vendor_id">
                            <input type="password" name="password" id="vendor-pass" required class="form-control">
                        </div>
                        <div class="col-md-3">
