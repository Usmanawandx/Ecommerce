									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __("Enter Product Name") }}"
												name="name" id="name" required="" value="{{ $data->name }}">
										</div>
									</div>
                                    <div class="row">
													<div class="col-lg-12">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<select id="childcat" name="childcategory_id"
												{{$data->subcategory_id == null ? "disabled":""}} required>
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">
									...
									<input type="file" style="visibility: hidden" id="feature_photo" name="photo" value="{{ $data->photo }}">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="previous_price" step="0.01" type="number" class="input-field"
												placeholder="e.g 20" value="{{round($data->previous_price * $sign->value , 2)}}"
												min="0">
										</div>
									</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		let html =
			`<img id="featrdReady"  src="{{ empty($data->photo) ? asset('assets/images/noimage.png') : asset('assets/images/products/'.$data->photo) }}" alt="">`;
