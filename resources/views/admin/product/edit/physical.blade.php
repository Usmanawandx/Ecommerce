...
@section('content')
                        ...
                        @include('includes.admin.form-both')
                                                ...
                                                <div class="row">
													...
													<div class="col-lg-12">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product URL') }}" name="slug" required="" value="{{ $data->slug }}" >
													</div>
												</div>
												<div class="row">
													<div class="col-lg-12">
													...
													<div class="col-lg-12">
														<input type="text" class="input-field" readonly placeholder="{{ __('Enter Product Sku') }}" name="sku" required="" value="{{ $data->sku }}">
                                              ...
                                              @endforeach
												...
												<div class="row">
													...
													<div class="col-lg-12">
															<select id="childcat" name="childcategory_id" {{$data->subcategory_id == null ? "disabled":""}} required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <select id="brands" name="brand_id" required>
                                                            <option value="">Select Brand</option>
                                                            @foreach($brand as $brands)
                                                                <option {{ $data->brand_id == $brands->id ? "selected" : ""  }} value="{{ $brands->id  }}">{{ $brands->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <select id="stores" name="vendor_id" required>
                                                            <option value="">Select Store</option>
                                                            @foreach($store as $stores)
                                                                <option {{ $data->vendor_id == $stores->id ? "selected" : ""  }} value="{{ $stores->id  }}">{{ $stores->shop_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
												...
												<div class="row">
													...
													<div class="row">
												        @php
                                                        if($data->size_prevoius_price != null || $data->size_prevoius_price != '')
                                                        {
                                                            $s_prev = explode(',',$data->size_prevoius_price);
                                                        }
                                                        @endphp
															<div  class="col-lg-12">
															</div>
																...
																<div class="product-size-details" id="size-section">
																	@if(!empty($data->size))
																	 @foreach($data->size as $key => $data1)
																		...
																		<div  class="row">
																				...
																				<div class="col-md-3 col-sm-6">
                                                                                    <label>
                                                                                        {{ __('Size Previous Price') }} :
                                                                                    </label>
                                                                                <input type="number" name="size_previous_price[]" class="input-field" placeholder="{{ __('Size Previous Price') }}" min="0" value="{{ isset($s_prev) ? round($s_prev[$key] * $sign->value , 2) : 0}}">
                                                                                </div>
																			</div>
																		</div>
																	 @endforeach
																	@else
																		...
																		<div  class="row">
                                                                                ...
                                                                                <input type="number" name="size_previous_price[]" class="input-field" placeholder="{{ __('Size Previous Price') }}" min="0" value="0">
                                                                                </div>
																			</div>
																		</div>
																	@endif
										...
										<div class="product-description">
											<div class="body-area">
							                     ...
							                     <div class="row">
							                      ...
							                      <input type="file" id="feature_photo" style="visibility: hidden" name="photo" value="{{ $data->photo }}" accept="image/*">
...
function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#featrdReady').remove();
                $('#landscape').css('background-image','url('+e.target.result+')')
                $('#landscape').css('background-size','cover');
                $('#landscape').css('background-repeat','no-repeat');
                $('#landscape').css('background-position','center');
  ...
  $(document).ready(function() {
    ...
    let html = `<img id="featrdReady" src="{{ empty($data->photo) ? asset('assets/images/noimage.png') : (filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo : asset('assets/images/products/'.$data->photo)) }}" alt="">`;
