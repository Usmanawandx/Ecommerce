							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Product URL') }}"
												name="slug" id="url-slug">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" id="sku" class="input-field" placeholder="{{ __('Enter Product Sku') }}"
												name="sku" readonly required=""
												value="">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<select id="childcat" name="childcategory_id" disabled="" required>
                                        ...
                                        <div class="col-lg-12">
                                            <select id="stores" name="vendor_id" required>
                                                ...
                                                @foreach($store as $stores)
                                                    <option value="{{ $stores->id  }}">{{ $stores->shop_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
													...
													<div class="size-area">
														...
														<div class="row">
															...
															<div class="col-md-3 col-sm-6">
																...
																<input type="number" name="size_previous_price[]" class="input-field"
																	placeholder="{{ __('Size Previous Price') }}" value="0" min="0">
															</div>
														</div>
													</div>
												</div>
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">
									...
									<input type="file" style="visibility: hidden" id="feature_photo" name="photo" value="">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="price" id="price" type="number" class="input-field"
                                    ...
                                    {{-- <div class="row">
										...
										<div class="col-lg-12">
											<input name="cost_price" id="cost_price" type="number" class="input-field"
												placeholder="{{ __('e.g 20') }}" step="0.01" required="" min="0">
										</div>
									</div> --}}
									<div class="row">
...
<script type="text/javascript">
 function readURL(input) {
    ...
    //     var price = $(this).val();
    //     var cid = $('#childcat').val();
    //     $.ajax({
    //         type: "get",
    //         url: "{{route('child.commission')}}",
    //         data: {
    //             'id':cid,
    //         },
