                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="heading-area">
                                            ...
                                            <select name="order_status" id="order_status">
                                                ...
                                                <option value="Cancelled">Cancelled</option>
                                                 ...
                                                 <option value="Delivered">Delivered</option>
                                                  <option value="Shipped- ECP">Shipped-ECP</option>
                                                   <option value="Shipped- LCS">Shipped-LCS</option>
                                        ...
                                        <button class="btn btn-sm btn-success" id="status_update">Update</button>
                                    </div>
