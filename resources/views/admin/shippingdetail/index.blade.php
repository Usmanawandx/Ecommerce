            ...
            <div class="product-area">
              <div class="row">
                ...
                <div class="row">
                  ...
                  <span style="margin-top:10px;"><a class="btn btn-primary" href="{{route('export-Shipping')}}">{{ __("Export Shipping CSV")}}</a></span>

                    <span style="margin-top:10px;"><a class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">{{ __("Import Shipping CSV")}}</a></span>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-shipping-detail-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('admin-shipping-detail-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
          '<i class="fas fa-plus"></i> {{ __('Add New Shipping Detail') }}'+
          '</a>'+
          '</div>');
      });
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form class="form-horizontal" action="{{ route('import_process') }}" method="POST" enctype="multipart/form-data">
          {{csrf_field()}}
