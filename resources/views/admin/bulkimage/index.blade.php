...
@section('content')
            <div class="content-area">
                <div class="mr-breadcrumb">
                    <div class="row">
                        <div class="col-lg-12">
                                <h4 class="heading">{{ __("Image Bulk Upload") }}</h4>
                                <ul class="links">
                                    <li>
                                        <a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;">{{ __("Bulk Upload") }} </a>
                                    </li>
                                </ul>
                        </div>
                    </div>
                </div>
                <div class="add-product-content" id="folders-section">
                    <div class="row" >
...
<div class="modal" id="upload-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <form action="{{route('upload-img')}}" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                @csrf
                <label for="">Upload Bulk Images</label>
                <input type="file" id="file" name="imgs[]" class="form-control" multiple="true" accept="Image/*" onchange="return fileValidation()">
                <input type="hidden" name="path" id="" value="{{$curPath}}">
