											...
											<form id="geniusform" action="{{ route('vendor-profile-update') }}" method="POST" enctype="multipart/form-data">
                      						 ...
                      						 @include('includes.vendor.form-both')  
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                      <div class="img-upload full-width-img">
                                                          <div id="image-preview" class="img-preview" style="background: url({{ $data->shop_logo ? asset('assets/images/vendorbanner/'.$data->shop_logo):asset('assets/images/noimage.png') }});">
                                                              <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>Upload Logo</label>
                                                              <input type="file" name="shop_logo" class="img-upload" id="logo-upload">
                                                            </div>
                                                            {{-- <p class="text">{{ $langg->lang521 }}</p> --}}
                                                      </div>
