...
{{--                                                    <li>--}}
{{--                                                        <a href="{{ route('vendor-dashboard') }}" class="wave-effect "><i class="fas fa-list"></i>{{ $langg->lang441 }}</a>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="{{route('vendor-order-index')}}"> <i class="fas fa-list"></i>KYC </a>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="{{ route('vendor-prod-import') }}"><i class="fas fa-list"></i>Bank Details</a>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i class="fas fa-list"></i>Withdrawals</a>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="{{ route('deposit') }}" class=" wave-effect"><i class="fas fa-list"></i>Deposit</a>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i class="fas fa-list"></i>My Tree</a>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i class="fas fa-list"></i>Transactions</a>--}}
{{--                                                    </li>--}}
{{--                                                </ul>--}}
{{--										    </div>--}}
{{--										</div>--}}
...
{{--							</li>--}}
							...
							<li>
								<a href="{{ route('user-dashboard') }}" class="wave-effect "><i class="fas fa-list"></i>{{ $langg->lang441 }}</a>
							</li>
{{--							<li>--}}
...
{{--								<ul class="collapse list-unstyled" id="order" data-parent="#accordion" >--}}
                            @if(Auth::user()->email == "mlmadmin@gmail.com")
                                   	<li>
                                    	<a href="{{route('mlm-investors')}}"> <i class="fas fa-list"></i> Investors </a>
                                	</li>
                            @endif
                                    <li>
                                    	<a href="{{route('mlm-kyc')}}"> <i class="fas fa-list"></i> KYC </a>
                                	</li>
{{--								</ul>--}}
{{--							</li>--}}
...
{{--							</li>--}}
							<li>
								<a href="{{ route('mlm-withdraw') }}" class=" wave-effect"><i class="fas fa-list"></i>Withdrawals</a>
							</li>
                            <li>
                                <a href="{{ route('deposit') }}" class=" wave-effect"><i class="fas fa-list"></i>Deposit</a>
                            </li>
                            <li>
                                <a href="{{ route('mlm-tree_view',['id' => Auth::user()->id]) }}" class=" wave-effect"><i class="fas fa-list"></i>My Tree</a>
                            </li>
                            <li>
                                <a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i class="fas fa-list"></i>Transactions</a>
                            </li>
                            @if(Auth::user()->email == "mlmadmin@gmail.com")
                                <li>
                                    <a href="{{ route('profit_distribute') }}" class=" wave-effect"><i class="fas fa-list"></i>Profit Distribute</a>
                                </li>
                            @endif
						</ul>
					</nav>
