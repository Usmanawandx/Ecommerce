          ...
          <div class="left-area">
            ...
            <div class="body-area">
              <form id="catalogForm" action="{{ route('front.category', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')]) }}" method="GET">
                ...
                @endif
                <h6 class="h6">Related Categories</h6>
                <ul class="filter-list">
                        @if(!empty($cat) && empty($subcat))
                            <li>
                            <div class="content">
                                <div class="sub-content open">
                                  <a href="{{route('front.category', [$cat->slug])}}" class="subcategory-link">{{$cat->name}}</a>
                                </div>
                            </div>
                            </li>
                        @elseif(!empty($cat) && !empty($subcat) && empty($childcat))
                            <li>
                            <div class="content">
                                <div class="sub-content open">
                                  <a href="{{route('front.category', [$cat->slug,$subcat->slug])}}" class="subcategory-link">{{$subcat->name}}</a>
                                </div>
                            </div>
                            </li>
                        @elseif(!empty($cat) && !empty($subcat) && !empty($childcat))
                            ...
                            <div class="content">
                                <div class="sub-content open">
                                    <a href="{{route('front.category', [$cat->slug,$subcat->slug,$childcat->slug])}}" class="subcategory-link">{{$childcat->name}}</a>
                                </div>
                            </div>
                            </li>
                        @endif
                ...
                <h6 class="h6">Related Brands</h6>
                @foreach($brands as $brand)
                    <input type="checkbox" id="{{$brand->id}}" name="brands[]" class="brandBox" >
