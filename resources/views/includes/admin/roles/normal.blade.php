...
@if(Auth::guard('admin')->user()->sectionCheck('bulk_product_upload'))
    ...
    <li>
        <a href="{{ route('admin-prod-import') }}"><i class="fas fa-upload"></i>{{ __('Import Update Comission') }}</a>
    </li>

@endif
@if(Auth::guard('admin')->user()->sectionCheck('bulk_image_upload'))
...
@endif
@if(Auth::guard('admin')->user()->sectionCheck('shipping_details'))
<li>
