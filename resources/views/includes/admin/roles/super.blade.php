<li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
            ...
            <li>
                <a href="{{route('admin-order-status-list','New')}}"> {{ __('New Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','processing')}}"> {{ __('Processing Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','completed')}}"> {{ __('Completed Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','Express')}}"> {{ __('Express Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','QC Failed')}}"> {{ __('QC Failed Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','Return to vendor')}}"> {{ __('Return to vendor Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','Shipped- LCS')}}"> {{ __('Shipped-LCS Orders') }}</a>
            </li>
             <li>
                <a href="{{route('admin-order-status-list','Shipped- ECP')}}"> {{ __('Shipped-ECP Orders') }}</a>
            </li>
             <li>
                <a href="{{route('admin-order-status-list','Cancelled')}}"> {{ __('Cancelled Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-status-list','Delivered')}}"> {{ __('Delivered Orders') }}</a>
            </li>
      ...
      <li>
        <a href="#purchaseVendorOrder" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('Vendor Purchase Order') }}</a>
        <ul class="collapse list-unstyled" id="purchaseVendorOrder" data-parent="#accordion" >
               <li>
                <a href="{{route('vendor_po.all','All')}}"> {{ __('Vendor PO') }}</a>
            </li>
        </ul>
    </li>
    <li>
    ...
    <li>
        <a href="{{ route('admin-bulk-image') }}"><i class="fas fa-upload"></i>{{ __('Bulk Image Upload') }}</a>
    </li>
    <li>
        <a href="{{ route('admin-comission-import') }}"><i class="fas fa-upload"></i>{{ __('Import Update Comission') }}</a>
    </li>

    <li>
        <a href="{{ route('admin-brand') }}"><i class="fas fa-upload"></i>Brands</a>
    </li>
    <li>
        <a href="{{ route('admin-shipping-detail-index') }}"><i class="fas fa-upload"></i>Shipping Details</a>
    </li>
    <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-shipping-index') }}"><span>{{ __('Shippings') }}</span></a>
            </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-sb-large',1) }}"><span>{{ __('Large Banners 1') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-sb-large',2) }}"><span>{{ __('Large Banners 2') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-sb-large',3) }}"><span>{{ __('Large Banners 3') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-sb-large',4) }}"><span>{{ __('Large Banners 4') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-sb-large',5) }}"><span>{{ __('Large Banners 5') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-cmspage-index') }}"><span>{{ __('CMS Pages') }}</span></a>
            </li>
        </ul>
    </li>
    <li>
