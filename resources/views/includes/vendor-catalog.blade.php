        <div class="col-lg-3 col-md-6">
          <div class="left-area">
            ...
            <div class="body-area">
              ...
              <form class="" id="priceForm" action="{{ route('front.vendor', Request::route('slug')) }}">
                  @if (!empty(request()->input('sort')))
                    <input type="hidden" name="sort" value="{{ request()->input('sort') }}" />
                  @endif
                    <h6 class="h6">Related Categories</h6>
                    @if(isset($relCategories))
                    <div class="brand-block">
                    @foreach($relCategories as $category)
                        <input type="checkbox" id="{{$category->id}}" name="category[]" class="categoryBox" >
                    ...
                    @foreach($brands as $brand)
                        <input type="checkbox" id="{{$brand->id}}" name="brand[]" class="brandBox" >
