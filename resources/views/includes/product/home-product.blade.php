							...
							<div class="col-lg-4 col-md-4 col-6 remove-padding">
										...
										<a href="{{ route('front.product', $prod->slug) }}" class="item">
											...
											<div class="info">
												...
												<h4 class="price">{{ $attrPrice != 0 ?  $gs->currency_format == 0 ? $curr->sign.$withSelectedAtrributePrice : $withSelectedAtrributePrice.$curr->sign :$prod->showPrice() }} <small class="text-success">{{$prod->discountPercent()}}</small></h4>
