											...
											<div class="item-img">
												...
												@endif
													...
													@if($prod->thumbnail == null)
													    ...
													    <img class="img-fluid"  style="height: 200px;width: 200px;"  src="{{asset('assets/images/products/'.$prod->photo) }}" alt="">
													    @else
													    <img class="img-fluid"  style="height: 200px;width: 200px;"  src="{{asset('assets/images/noimage.png') }}" alt="">
													    @endif
													@elseif(file_exists(public_path().'assets/images/thumbnails/'.$prod->thumbnail))
													    <img class="img-fluid"  style="height: 200px;width: 200px;"  src="{{asset('assets/images/thumbnails/'.$prod->thumbnail) }}" alt="">
													@else
													    @if($prod->photo != null && file_exists(public_path().'assets/images/products/'.$prod->photo))
													    <img class="img-fluid"  style="height: 200px;width: 200px;"  src="{{asset('assets/images/products/'.$prod->photo) }}" alt="">
													    @else
													    ...
													    @endif
													@endif
													<!--<img class="img-fluid"  style="height: 200px;width: 200px;"  src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):(filter_var($prod->photo,FILTER_VALIDATE_URL)?$prod->photo:(file_exists( public_path().'assets/images/products/'.$prod->photo)?asset('assets/images/thumbnails/'.$prod->photo):asset('assets/images/noimage.png'))) }}" alt="">-->
											</div>
											<div class="info">
												<div class="stars">
													<div class="ratings">
