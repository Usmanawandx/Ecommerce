			...
			<div class="single-box">
				<div class="left-area">
													...
													@else
													    ...
													    @endif
													@endif
					<!--<img style="height: 200px;width: 200px;" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="">-->
				</div>
				<div class="right-area">
						<div class="stars">
							...
							<h4 class="price">{{ $attrPrice != 0 ?  $gs->currency_format == 0 ? $curr->sign.$withSelectedAtrributePrice : $withSelectedAtrributePrice.$curr->sign :$prod->showPrice() }} <del>{{ $prod->showPreviousPrice() }} </del> <small class="text-success">{{$prod->discountPercent()}} </small></h4>
