...
class BannerController extends Controller
{
    ...
    //*** GET Request
    public function large($page)
    {  
        return view('admin.banner.large',compact('page'));
    }
    //*** GET Request
    ...
    //*** GET Request
    public function largecreate($page)
    {
        return view('admin.banner.largecreate',compact('page'));
    }
