    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('category',function(Subcategory $data){
                                return'<a href="'.route("front.category",$data->category->slug) .'" class="single-category" target="blank">'.$data->category->name.'</a>';
                            })
                            ->editColumn('name',function(Subcategory $data){
                                return'<a href="'.route("front.subcat",['slug1'=>$data->category->slug,'slug2'=>$data->slug]) .'" class="single-category" target="blank">'.$data->name.'</a>';
                            })
                            ->editColumn('slug',function(Subcategory $data){
                                return'<a href="'.route("front.subcat",['slug1'=>$data->category->slug,'slug2'=>$data->slug]) .'" class="single-category" target="blank">'.$data->slug.'</a>';
                            })
                            ...
                            ->rawColumns(['status','slug','name','category','attributes','action'])
